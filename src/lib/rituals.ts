...
export type Ritual = { id: string; name: string; intent: Intent; durationLabel: string; steps: RitualStep[]; closingLine: string };
...
export const RITUALS: Ritual[] = [
  ...
  },
  {
    ...
    steps: [
      { id: "s1", prompt: "What happened? (just the facts)" },
      { id: "s2", prompt: "What did you feel?" },
      { id: "s3", prompt: "What story did you tell yourself about it?" },
      { id: "s4", prompt: "What do you need right now?" },
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      { id: "s2", prompt: "If you want, add: “What I wish I could say is…”" },
    ],
